...
return [
    ...
    */
    ...
    'gte'                  => [
        'array'   => ':attribute 必须大于等于 :value 个单元。',
    ...
    'password'             => [
        ...
        'uncompromised' => '所提供的 :attribute 已在数据泄露中出现，请选择其他 :attribute。',
    ],
    ...
    'required_array_keys'  => ':attribute 必须包含 :values 的条目。',
